...
public class CamperGUI
{
   ...
   JTextField textWeekOrWeekend = new JTextField(20);
   JTextField textField_EstKm = new JTextField(20);
   JLabel lblEstimatedKm = new JLabel("Estimated KM:");
   JLabel lblWeekOrWeekend = new JLabel("Week/Weekend rental:");
   ...
   private void addingToFrame()
   {
      ...
      frame.getContentPane().add(lblWeekOrWeekend);
      frame.getContentPane().add(textWeekOrWeekend);
   ...
   {
      textWeekOrWeekend.setBounds(227, 316, 232, 20);
      ...
      lblWeekOrWeekend.setBounds(42, 319, 138, 14);
