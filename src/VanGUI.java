...
public class VanGUI
{
   ...
   JTextField textFieldVanSize = new JTextField(20);
   ...
   private void addingToFrame()
   {
      ...
      frame.getContentPane().add(textFieldVanSize);
   ...
   {
      textFieldVanSize.setBounds(227, 316, 232, 20);
      ...
      lblVanSize.setBounds(42, 319, 110, 14);
